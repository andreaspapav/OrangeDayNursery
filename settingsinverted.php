...
<body onload="checkToggleState('musicToggleBtn'); checkToggleState('soundFXToggle'); checkToggleState('invertToggle')" scroll="no" style="overflow: hidden">
	...
	<div class= "container">
<!-- Background Page -->
		<img src='CSS/img/settings/inverted/backgroundinverted.png' style = "resize: both; height: 100vh; width:100vw; position: absolute; top:0%;left:0%;"> </div>

<!-- Back button upper-left corner -->
		<a class="buttonWithSound" href="indexinverted.php"><img src='CSS/img/settings/backButton.png' onmousedown="checkToggleState('soundFXToggle')" onmouseover="this.src='CSS/img/settings/inverted/backButtonhoverinverted.png';" onmouseout="this.src='CSS/img/settings/inverted/backButtoninverted.png';"  style="width:12vw;height:6vh;position: absolute;top: 20px;left: 20px;" /></a>
	
<!-- Languages Settings -->
<!-- Select langugage title image -->

<img src="CSS/img/settings/inverted/selectLanginverted.jpg" style="position: absolute; resize: both; height: 4vh; width: 25vw; top:30% ; left: 24.5%;">


<div class="image">
  <img src="CSS/img/settings/inverted/textboxwhiteinverted.png" style="position: absolute; resize: both; height: 30vh; width: 27vw; top:34% ; left: 24%;">
  <img src="CSS/img/settings/inverted/langBGinverted.jpg" style="position: absolute; resize: both; height: 28vh; width: 12vw; top:35.5% ; left: 57%;">
  <img src="CSS/img/settings/inverted/lineinverted.png" style="position: absolute; resize: both; height: 0.5vh; width: 13vw; top:48.5% ; left: 31%; transform: rotate(90deg);"> </div>
<!-- Select Voice langugage title image -->
<img src="CSS/img/settings/inverted/voiceLanginverted.jpg" style="position: absolute; resize: both; height: 4.2vh; width: 25vw; top:30% ; left: 50.5%;">
...
<input type="submit" value="SAVE" style="width: 7vw; height: 5vh; font-size: 1.6vw;font-weight: bold; left: 46.5%; top:62.5%; color: white; background-color: #134b89;" multiple >
</form>
...
<img src="CSS/img/settings/inverted/musicSetinverted.jpg" style="position: absolute; resize: both; height:6.5vh; width: 14vw; top: 70.5%; left: 24.4%;">
<!-- Sound FX -->
<img src="CSS/img/settings/inverted/soundFXSetinverted.jpg" style="position: absolute; resize: both; height:6.5vh; width: 14vw; top: 70.7%; left: 43%;">
<!-- Invert Color -->
<img src="CSS/img/settings/inverted/invertColorSetinverted.jpg" style="position: absolute; resize: both; height:6.5vh; width: 14vw; top: 70.6%; left: 61.5%;">
<!-- Line split -->
<img src="CSS/img/settings/inverted/lineinverted.png" style="position: absolute; resize: both; height: 0.5vh; width: 44vw; top:68%; left:28%; opacity: 0.8;">
